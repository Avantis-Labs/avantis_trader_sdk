...
| --- | --- | --- |
| `AVANTIS_PRIVATE_KEY` | (none) | Signing key. An API/agent key from the [Avantis API Key Generator](https://avantis-delegate-ui.preview.avantisfi.link/), or your wallet key. |
