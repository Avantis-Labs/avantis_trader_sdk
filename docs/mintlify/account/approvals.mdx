...
<Warning>
Approvals must come from the **trader's own key** — they cannot be routed through a delegate/API key. If you onboarded via the Avantis UI, USDC was approved in the same flow and you can skip this.
</Warning>
