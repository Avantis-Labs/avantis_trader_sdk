...
Generate an API key on the [Avantis API Key Generator](https://avantis-delegate-ui.preview.avantisfi.link/); one wallet signature registers it. Then set the two env vars and trade. See [Quickstart](/quickstart).
