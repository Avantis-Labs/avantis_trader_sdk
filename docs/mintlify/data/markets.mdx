...
<Note>
The v2 spread engine is live on testnet. Mainnet serves the legacy engine until the v2 cutover — use `client.markets.dynamic_spread(...)` (same arguments, response key `dynamicSpreadPct`) there in the meantime.
</Note>
