...
| (none) | `client.pair_data_stream()` (live pair-catalog updates; see the [Socket.IO protocol](/data/socket-io)), `client.order_event_stream()` (your order lifecycle events) |
...
- **Builder codes**: `account.register_builder_code(...)` for order-flow
  attribution and fees. See [Builder codes](/builders/builder-codes).
